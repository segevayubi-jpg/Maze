...
public class MainFrame extends JFrame {
    ...
    private void createLayout() {
        ...
        configPanel.setBorder(
                BorderFactory.createTitledBorder("Render Configuration")
        );
        ...
        configPanel.add(new JLabel("Animation Delay:"));
        configPanel.add(animationDelayLabel);
        ...
        sizePanel.setBorder(
                BorderFactory.createTitledBorder("Maze Size")
        );
